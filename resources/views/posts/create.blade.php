...
<div class="container col-lg-8 col-md-10">
	...
	<form action="{{route('posts.store')}}" method="post" id="js-post-form">
		@csrf
	
        <div class="form-group">
            <label for="js-title">Título da postagem</label>
            <input type="text" class="form-control" id="js-title" name="titulo" maxlength="100" required/>
            <p class="text-muted">Máximo 100 caracteres</p>
        </div>
        
        <div class="form-group">
            <label for="js-resumo">Resumo da postagem</label>
            <textarea class="form-control" id="js-resumo" rows="3" maxlength="300" name="resumo" required></textarea>
            <p class="text-muted">Máximo 300 caracteres</p>
        </div>
        
        <div id="js-quill-container"><!-- Conteúdo da postagem --></div>
...
<script src="{{ asset('js/posts_create.js') }}"></script>
@stop